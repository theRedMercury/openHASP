...
#define COLOR_BTN_PR (lv_color_lighten(HUE_COLOR, LV_OPA_10))
#define COLOR_BTN_PR_GRAD lv_color_darken(HUE_COLOR, LV_OPA_50)
#define COLOR_BTN_CHK (lv_color_lighten(CHK_COLOR, LV_OPA_0))
#define COLOR_BTN_CHK_GRAD (lv_color_darken(CHK_COLOR, LV_OPA_60))
